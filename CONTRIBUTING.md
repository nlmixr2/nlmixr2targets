...
This outlines how to propose a change to nlmixrtargets. For more
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("nlmixrdevelopment/nlmixrtargets", fork = TRUE)`.
...
[Contributor Code of
Conduct](https://nlmixr2.github.io/nlmixr2targets/CODE_OF_CONDUCT.md).
